  ...
  return (
    <div>
      <div className='about-text'>
        ...
        <p className='descript hs'>I am a full-stack web developer. I am currently on job search. A typical day for me involves 8 hours of coding, collaboration within multicultural teams and a perfect mimic of a real working environment.
